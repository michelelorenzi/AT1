...
Everything in these notes should be taken with a grain of salt: I was young and inexperienced when I took them! In particular, the notes were never checked or officially approved by the lecturer, and it goes without saying that I am responsible for any mistakes they may contain. I have a \href{https://github.com/michelelorenzi/AT1}{GitHub repository} for the notes, and you are very welcome to use the \href{https://github.com/michelelorenzi/AT1/issues}{Issues tab} to report any errors or typos, or make any correction (or you can just tell me in some other way). Note however that major updates are unlikely.
...
\input{Chapters/AT1-Lecture9}
\input{Chapters/AT1-Lecture10}
\input{Chapters/AT1-Lecture11}
\input{Chapters/AT1-Lecture12}
\input{Chapters/AT1-Lecture13}
\input{Chapters/AT1-Lecture14}
\input{Chapters/AT1-Lecture15}
\input{Chapters/AT1-Lecture16}
\input{Chapters/AT1-Lecture17}
\input{Chapters/AT1-Lecture18}
\input{Chapters/AT1-Lecture19}
\input{Chapters/AT1-Lecture20}
\input{Chapters/AT1-Lecture21}
\input{Chapters/AT1-Lecture22}
\input{Chapters/AT1-Lecture23}
\input{Chapters/AT1-Lecture24}
\input{Chapters/AT1-Lecture25}
\input{Chapters/AT1-Lecture26}

\input{Chapters/AT1-Appendix-ex}
