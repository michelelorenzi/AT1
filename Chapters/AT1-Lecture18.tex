...
In general, $\Nat(H^n(-;A),H^m(-;B))\cong H^m(K(A,n);B)$ are called the cohomology operations of type $(A,n,B,m)$.\todo{AT1Sheet10.3 has some interesting stuff about this, maybe add it}
