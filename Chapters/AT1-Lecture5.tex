...
Step 1.\rightnote{I would rephrase this as follows (see \cite[Th.7.1]{maclane:71}): every presheaf on\\ a small category can be represented as a colimit of representable presheaves (in a canonical way).} Given $H:Z\times\Delta[1]\to Y$ and $z\in Z_n$, we define $\psi^H_z:\Delta[n]\times\Delta[1]\to Y$ by
